...
- neigh_degree - степень связности для 2<sup>k</sup>-связной сетки (то есть параметр k). Целое число больше либо равное 2, учитывается если выбран алгоритм CBS или ECBS. Опциональный параметр, значение по умолчанию равно 2
